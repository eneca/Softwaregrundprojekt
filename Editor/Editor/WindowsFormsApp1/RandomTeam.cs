...
namespace WindowsFormsApp1
{
    ...
    class RandomTeam
    {
        private readonly List<string> FemaleNames;
        private readonly List<string> MaleNames;
        private readonly List<string> Teamname;
        private readonly List<string> Motto;
        private readonly List<string> Brooms;
        private readonly List<Image> Logos;
        private readonly Color[] TrikotColor;
        ...
        public RandomTeam()
        {
            ...
            Brooms = new List<string> { "tinderblast", "cleansweep11", "comet260", "nimbus2001", "firebolt" };
...
;           TrikotColor = new Color[2];
        ...
        public OutputData RandomTeamComposition()
        {
            ...
            Fans fan = new Fans(fans[0], fans[1], fans[2], fans[3], fans[4]);
